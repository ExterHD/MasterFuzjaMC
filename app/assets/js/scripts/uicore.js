        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/ExterHD/MasterFuzjaMC/releases/download/v${info.version}/MasterFuzja-Launcher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : '-x64'}.dmg`
                    showUpdateUI(info)
                }
            ...
            case 'update-not-available':
                ...
                settingsUpdateButtonStatus('Sprawdź aktualizację')
                break
            case 'ready':
